 ...
 setLoading(true)
  ...
  return !loading? (
    <div className="flex justify-center items-center h-screen ">
            <div className="max-w-md w-full bg-white p-8 rounded-lg shadow-lg mb-[200px]">
                <h2 className="text-2xl font-semibold mb-4">Login</h2>
                <h4> New User?Welcome!! <p className='text-blue-600 bg-slate-50 hover:cursor-pointer' onClick={()=>navigate("/signup")}>Click to SignUp  </p> </h4>
                        ...
                        <input
                            ...
                            {...register("email",{
                                ...
                                validate:{
                                    ...
                                    "Use proper syntax(eg. abc@xyz.com)"
                                }
                            })}
                        />
